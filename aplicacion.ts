 ...
 */
 ...
 var cantidadSolicitado:number=35;
 
/*  if(cantidadSolicitado>15){
     debugger
     console.log('tiene que aplicar un descuento');
 }
 */

 /* cantidadSolicitado  >  15 ?  console.log ( "tiene que aplicar un descuento")  : console.log  ("no consigue descuento"); */
///for ciclos

/* var listadodeNombre2:Array<string>=["maria","carmen","johana","Ana"]

for(var cantidadRepetir:number=0;cantidadRepetir < listadodeNombre2.length;cantidadRepetir++){
    console.log(listadodeNombre2[cantidadRepetir]);
}
 */

/* for(var cantidadRepetir:number = 1;cantidadRepetir <= 5;cantidadRepetir++){
...
var listadoDeUsuario: Array<Usuario> = [
    {
        nombre:'ana',
        apellido:'gonazales'
